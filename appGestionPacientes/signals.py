from appGestionPacientes.middleware import RequestMiddleware
...
from appGestionPacientes.models import Navigation
import logging
import json

log = logging.getLogger('appGestionPacientes.signals')
