...
class Propertie(models.Model):
	key = models.CharField(unique=True, max_length=100, verbose_name="key")
...
class Task(AuditModel, models.Model):
	...
	dateCreate = models.DateTimeField(auto_now_add=True, blank=True, null=True, verbose_name="Fecha de creación")
